...
export const TypewriterEffectSmoothSmaller = ({
    words,
    className,
    cursorClassName
}: {
    ...
    return (
        <div className={cn('flex space-x-1 my-6', className)}>
            ...
            >
                <div
                    className="lg:text:1xl font-bold text-xl xl:text-2xl"
                    style={{
                        whiteSpace: 'nowrap'
                    }}
                >
            ...
            <motion.span
                ...
                className={cn('block rounded-sm w-[4px]  h-6 xl:h-9 bg-white-500', cursorClassName)}
            ></motion.span>
        </div>
    );
};